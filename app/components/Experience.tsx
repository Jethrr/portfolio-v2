  ...
  return (
    <Card className="col-span-12">
      ...
      <CardBody className="gap-0">
        ...
        <div className="mt-4 flex items-center gap-2 pt-5 pb-3 font-mono text-[10px] font-medium uppercase tracking-[0.18em] text-neutral-500">
          ...
          {organizations.map((org, i) => (
            <li
              ...
              className={[
                ...
                i !== organizations.length - 1 ? "border-b border-[var(--border)]" : "",
              ].join(" ")}
            >
              <div className="flex flex-col gap-1">
                <span className="font-mono text-[11px] uppercase tracking-wider text-neutral-500">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
                  <h3 className="text-base font-medium text-neutral-100">{org.role}</h3>
                  <span className="text-neutral-600">·</span>
                  {org.link ? (
                    <a
                      href={org.link}
